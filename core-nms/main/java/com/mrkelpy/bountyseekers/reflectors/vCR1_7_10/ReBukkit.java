 ...
 * <font color="yellow"> This class is compatible with Crucible Version 1.7.10</font>
 */
public class ReBukkit implements IBukkitReflector {
    ...
    public class CraftItemStack extends IBukkitReflector.CraftItemStack {
        ...
        public ItemStack asBukkitCopy(Object nmsItemStack) {
            try {
                return (ItemStack) CLASS.getMethod("asBukkitCopy", ReCrucibleNMS.INSTANCE.new ItemStack().CLASS).invoke(CLASS, nmsItemStack);
